...
```javascript
import fliplr5d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-fliplr5d@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/array-base-fliplr5d/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/array-base-fliplr5d/actions/workflows/test.yml?query=branch:v0.2.2
